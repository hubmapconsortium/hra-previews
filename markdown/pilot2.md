...
The experimental skin data used here is detailed in the “[Human Digital Twin: Automated Cell Type Distance Computation and 3D Atlas Construction in Multiplexed Skin Biopsies**](https://www.biorxiv.org/content/10.1101/2022.03.30.486438v1)” paper (pre-print version).

#### **The pre-print version  "Human Digital Twin: Automated Cell Type Distance Computation and 3D Atlas Construction in Multiplexed Skin Biopsies" has been updated to the formal paper titled "Human Digital Twin: 3D Atlas Reconstruction of Skin and Spatial Mapping of Immune Cell Density, Vascular Distance, and the Effects of Sun Exposure and Aging." The formal paper has been accepted by Communications Biology, and the link will be updated once the final version is available.
